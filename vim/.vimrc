...
au BufRead,BufNewFile *.py,*pyw,*.go,*.R set shiftwidth=4
au BufRead,BufNewFile *.py,*pyw,*.go,*.R set tabstop=4
au BufRead,BufNewFile *.py,*pyw,*.go,*.R set softtabstop=4
au BufRead,BufNewFile *.py,*.pyw,*go,*.R set expandtab
"au BufRead,BufNewFile *.py,*.pyw set autoindent

" Display tabs at the beginning of a line in Python mode as bad.
au BufRead,BufNewFile *.py,*.pyw match BadWhitespace /^\t\+/

" Remove the trailing whitespace when save
...
""""""""" JSON +
au BufRead,BufNewFile *.json,*.html,*js set shiftwidth=2
au BufRead,BufNewFile *.json,*.html,*.js set tabstop=2
au BufRead,BufNewFile *.json,*.html,*.js set softtabstop=2
au BufRead,BufNewFile *.json,*.html,*.js set expandtab
"
""""""""" C !
